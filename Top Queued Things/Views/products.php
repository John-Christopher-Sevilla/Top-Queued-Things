...
<header class="p-3 bg-dark text-white">
  ...
  ?>
      <div class="text-end ses_start">
          <h5>Hello Admin</h5>
          <a href="adminProfile.php" class="btn btn-outline-warning">Profile</a>
   ...
   <h3>My Products</h3>
	  		<table class="table table-secondary">
	  			...
	  			<?php
	  				...
	  				$sql = "SELECT a.item_name, a.item_desc, a.item_img, a.item_code, b.cat_name, a.item_price FROM `items` a JOIN `category` b ON a.cat_id = b.cat_id;";
